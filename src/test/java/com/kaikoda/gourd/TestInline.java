...
public class TestInline {
	...
	public void testInline_copyVerbatim() throws Exception {					
		...
		processor.setPipeline(new URI(TestCommandLineXmlProcessor.getAbsolutePath("/xproc/inline/copy_verbatim.xpl", false)));		
		
		String expected = FileUtils.readFileToString(new File(TestCommandLineXmlProcessor.getAbsolutePath("/data/control/hello_world.xml", true)), "UTF-8");		
